#include <stdio.h>
#include "mpi.h"
/* This example handles a 12 x 12 mesh, on 4 proce
ssors only. */
#define maxn 12
int main( argc, argv )
int argc;
char **argv; {
    ...
    */
    /* Note that we use MPI_PROC_NULL to remove th
    e if statements that
    ...
    /* Send down and receive from above (shift dow
    n) */
